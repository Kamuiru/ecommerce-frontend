              ...
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form class="mx-1 mx-md-4">
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input type="password" id="form3Example4cd" class="form-control" v-model="password2"/>
                  ...
                  <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                    <button @click="submitForm()" type="button" class="btn btn-primary btn-lg">Register</button>
                  </div>
...
function submitForm(){
    ...
    if(password.value == ''){
        errors.value.push('password field is required');
    }
    if(password2.value !== password.value){
        errors.value.push('password confirmation field is required');
    }
